        ...
        <div class="col-md-6 col-sm-3 col-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number">Product Color :{{$product->color}}</span>
            </div>
          </div>
        </div>
          ...
          <div class="card card-primary">
            ...
            <form action="{{route('product_attr.store')}}" method="POST" enctype="multipart/form-data" class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="text" name="sku" id="inputsku" class="form-control" value="{{old('sku')}}"  autocomplete="off" placeholder="SKU" required>
              </div>
              <div class="form-group">
